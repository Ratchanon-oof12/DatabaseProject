    ...
    <main className="page-enter w-full max-w-[900px] bg-surface rounded-[2.5rem] neo-raised p-6 md:p-8 flex flex-col md:flex-row items-center gap-8 md:gap-12">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left p-4 md:pl-8">
        ...
        <p className="text-on-surface-variant font-medium text-lg leading-relaxed">
          Welcome back to your neomorphic library. Access your favorite books, articles, and blogs seamlessly.
        </p>
      </div>
      ...
      <div className="w-full md:w-1/2 bg-surface rounded-3xl p-8 md:p-10 neo-pressed">
        ...
        <div className="flex gap-4 mb-8">
          {/* Active Tab */}
          <Link to="/login" className="flex-1 py-4 px-2 rounded-xl bg-surface text-primary font-semibold flex items-center justify-center gap-2 neo-pressed transition-all duration-300 text-base md:text-lg hover:text-tertiary">
            <span className="material-symbols-outlined text-sm">login</span>
            Login
          </Link>
          {/* Inactive Tab */}
          <Link to="/register" className="flex-1 py-4 px-2 rounded-xl bg-surface text-secondary font-medium flex items-center justify-center gap-2 neo-raised neo-interactive transition-all duration-300 text-base md:text-lg hover:text-primary hover:bg-surface-variant/30">
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <div className="flex justify-end mt-3">
              <a className="text-sm text-primary font-medium hover:text-tertiary transition-colors" href="#">Forgot password?</a>
            </div>
          </div>
